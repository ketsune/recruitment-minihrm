...
const row = (item, { checkStatus, reject, selectStatus, changeStatus }) => (
  <Table.Row key={item.citizenId}>
    ...
    <Table.Cell><Checkbox name='accept' checked={checkStatus[item.citizenId] === 'Sign Contract' ? true : false} onChange={() => changeStatus(item.citizenId, 'Sign Contract')} /></Table.Cell>
...
const PassTable = ({ data, onSearchChange, sortKey, direction, handleSort, onConfirm, checkStatus, reject, selectStatus, changeStatus, clearStatus }) => (
  <div>
