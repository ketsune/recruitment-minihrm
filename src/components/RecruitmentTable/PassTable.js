          ...
          <Table.HeaderCell colSpan="11">
            <div>
              <Form onSubmit={onConfirm}>
                <Form.Group >
                  <Field name="date" as={Form.Input} component={Input} label="Data" placeholder="Date" type="date" onChange={(event, value) => setPassDate(value)} />
                  <Field name="time" as={Form.Input} component={Input} label="Time" placeholder="Time" type="time" onChange={(event, value) => setPassTime(value)} />
                </Form.Group>
              </Form>
            </div>
